...
import { ClinikoApiResponse } from "@/types/clinikoTypes";
  ...
  if (endpoint.includes('appointments')) {
    ...
    const appointments = [
      {
        ...
        created_at: lastAppointmentDate.toISOString(),
        updated_at: lastAppointmentDate.toISOString(),
        starts_at: lastAppointmentDate.toISOString(),
        ends_at: new Date(lastAppointmentDate.getTime() + 30 * 60000).toISOString(),
        cancelled_at: null,
    ...
    if (futureDays !== null) {
      ...
      appointments.push({
        ...
        ends_at: new Date(futureDate.getTime() + 30 * 60000).toISOString(),
        cancelled_at: null,
        did_not_arrive: false,
